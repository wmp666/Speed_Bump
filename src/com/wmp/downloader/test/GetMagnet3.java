...
public final class GetMagnet3 {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        final String magnet = "magnet:?xt=urn:btih:3a8a09a5aae8aca84d3990ce62a2c664e2ef5892&dn=zh-cn_windows_10_consumer_editions_version_22h2_updated_oct_2025_x64_dvd_38efd00d.iso&xl=7168839680";
        ...
        byte[] data = s.fetchMagnet(magnet, 30, DataControl.getTempPath());
        if (data == null) {
        ...
        fos.write(data);
        s.download(new TorrentInfo(f), DataControl.getTempPath());
