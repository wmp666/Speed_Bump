...
public class BTFolderDownloadTask extends DownloadTask {
    ...
    public BTFolderDownloadTask(String folderName, File savePath, String torrentFilePath, long chooseSize, boolean[] chooseFilesStatus) {
        super(folderName, savePath);
        this.chooseFiles = chooseFilesStatus;
