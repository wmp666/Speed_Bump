...
public class ToastMessage {
    ...
    public static void show(Component c, String message, Toast.Type type, boolean isUseHeavyWeight) {
        ...
        Toast.show(c, type, message, ToastLocation.BOTTOM_TRAILING, new ToastOption()
                .setDelay(2000)
                .setHeavyWeight(isUseHeavyWeight));
    ...
    static void main() {
        ...
        button.addActionListener(e -> {
            ToastMessage.show(frame, "This is a toast message2", ToastMessage.INFO, true);
        ...
        button2.addActionListener(e -> {
            ToastMessage.show(frame, "This is a toast message1", ToastMessage.INFO);
