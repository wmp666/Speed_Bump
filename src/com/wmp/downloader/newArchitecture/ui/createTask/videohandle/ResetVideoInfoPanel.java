...
public class ResetVideoInfoPanel extends JPanel {
    ...
    static class ResetVideoInfoTask extends AbstractTask {
        ...
        public ResetVideoInfoTask(File inputFile, File outputFile,
                                  String containerFormat, String videoCodec, String audioCodec) {
            var jsonObject = new JSONObject();
            jsonObject.put("rootName", outputFile.getName());
            jsonObject.put("savePath", outputFile.getAbsolutePath());
            super(jsonObject);
